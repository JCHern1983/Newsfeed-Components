...
function makeArticles(dataCard) {
...
// set text content
articleTitle.textContent = dataCard.title;
dateText.textContent = dataCard.date;
text1.textContent = dataCard.firstParagraph;
text2.textContent = dataCard.secondParagraph;
text3.textContent = dataCard.thirdParagraph;
expandButton.textContent = '	\u21F5	';


//styles
expandButton.style.fontSize = "30px";
...
data.forEach(item => {
  articles.appendChild(makeArticles(item));
})  
